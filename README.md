- _В папке ./collection находится коллекция запросов, которую вы можете открыть с помощью Postman. В этой коллекции представлены все запросы для вашего ознакомления и тестирования._
